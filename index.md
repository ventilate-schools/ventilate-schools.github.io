...
# Kids and Teachers being sick all the time is not good

COVID-19 has weakened people's immune systems to many diseases (Flu, RSV, Staph, Strep, Measles). We have to lower transmission in schools as kids bring it home to parents and it just keeps taking its turn with other principally airborne pathogens. We **know exactly how to do this** _without_ putting everyone in masks or making people attend school remotely (or lockdowns again).

## COVID is airborne (a fact suppressed at the start)

Given we now know **COVID-19 is airborne** and even the WHO has accepted that with a long "airborne risk assessment" for COVID-19 [(*)](https://iris.who.int/handle/10665/376346), the world slowly pivots to airborne disease transmission mitigations. In March of 2024, after the publication of the WHO document, 33 professors and PhDs pushing for a policy change in an article on **Science.org**: [Mandating indoor air quality for public buildings](https://drive.google.com/file/d/16l_IH47cQtC7fFuafvHca7ORNVGITxx8/view).
...
Better ventilate schools for long term student and teacher health is the push, but need to track the progress for that in in each country. We should do so ahead of government effort to do the same. If government starts to track this work, this effort will continue because that effort might might be weak. The published Science.org article above highlights schools as a key place for active ventilation work. That should should be mechanical heat recovery ventilation (MHRV)  in this age. It also means air filtration/cleaning too, and CO2 monitoring to drive ventilation levels, as CO2 inside is a proxy indicator for COVID-19 transmission risk. As it happens the WHO document details all of these, too.

## Healthy full attendance at school

 When we say student and teacher health, we're wanting absences to go down too. A prior tactic on absences from school was forcing sick people to attend. If we lower transmission in schools, we increase attendance. We also reduce multi-generation transmission outside schools too. Kids were bringing COVID-19 home and infecting their parents and grandparents. With lowered transmission, we also reduce long COVID, where the worst sufferers have disappeared from eduction and may be unable to earn a living for the rest of their lives.

# Action Plan

What to do is **ventilate schools** and there are a number of articles about it:
...
We know we can't eliminate transmission in schools - we're just aiming for "lower chance of spread" which would be a reproduction number "RO" under 1.0 per infected student or teacher. [Google search for RO](https://www.google.com/search?q=r0+Basic+reproduction+number)

## School Ventilation Ideals

The Center for Green Schools (CfGS) has a number of resources for their, including an hour-long video on "Unanswered Questions on ASHRAE standard 241 and CDC Ventilation Standard Guidance for Schools": 
...
4. We also need legislation that requires the completion of such work in classrooms. The legislation should also certify that the work has been done, inspections happen that the work is correct, and has measures to intervene if the work is not correct.
...
Ideally 1 & 2 are engineered solutions, fitted build expert and licensed building contractors. You don't have to wait - freestanding works to fill a gap, and the DIY options are cheap an effective. They are cheap enough to be donated by parent groups. See the *5th Graders Make..* video, below.
...
Note: Ionization of the air is not recommended as it creates ozone. Ozone being harmful to people. Upper room ultraviolet technology may play a part in virus inactivation as the technology reaches mass production.
...
If the windows are open then CO&#8322; will not build up so fast, but there has to be an air currant to force air through the room. Over a hundred years ago, Florence Nightingale [campaigned for decades](https://www.google.com/search?q=Florence+Nightingale+stale+air) for windows to be opened to reduce airborne disease transmission in public buildings. She also campaigned for high ceilings those buildings. Because of the open windows, buildings had to have dialed-up heating systems that would be very expensive today, so we prefer mechanical heat recovery ventilation (MHRV) and energy recovery ventilation (ERV) systems. We can now also scrub the air of viruses (suspended in one-micron size water vapor aerosols) using air filters and cleaners. There are DIY alternatives that are just as good. Air filters do not address the CO&#8322; levels themselves, which can contribute to drowsiness on its own at very high levels. Air filters do address smoke particles from nearby cars and truck exhausts and pollen, though.
...
* [5th Graders Make DIY Air Purifiers for Entire School](https://www.youtube.com/watch?v=qZzzEKElIFo) 3 mins minute video from Jeffco Public Schools (Colorado)
...
Grades of 0 to 5 ("very poor" to "excellent") should realities in 2025.
...
* CO2 Monitoring (VOC or NDIR): CO2 monitoring constant and and imperfectly automating ventilation.
...
Australian activists have created [Covid Safety for Schools](https://www.covidsafetyforschools.org/) which is a comprehensive resource for teachers, parents and students. The materials are initially for Australia, but just as applicable to any other country on earth. 
...
This site is edited by volunteers who're interested in accelerating the work to complete the adequate ventilation of schools. This effort was not commissioned by education authorities or governments. The volunteers are in groups around countries, states, provinces, cities.
